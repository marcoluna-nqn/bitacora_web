class Validators {
  ...
  static bool isNumericColumn(String header, int index) {
    ...
    if (h.contains('ω') || h.contains('ohm') || h.contains('resist') || h.contains('@1m') || h.contains('@3m')) return true;
    if (h.contains('1m') || h.contains('3m') || h.contains('valor') || h.contains('número')) return true;
